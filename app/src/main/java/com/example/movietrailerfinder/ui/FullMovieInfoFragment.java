...
import com.example.movietrailerfinder.adapters.TreilersREcyclerViewAdapter;
...
public class FullMovieInfoFragment extends android.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(poster.getContext()).load(getString(R.string.poster_base_url) + movie.getPosterPath()).error(R.drawable.emty_poster).into(poster);
